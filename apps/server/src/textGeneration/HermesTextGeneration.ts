...
export const makeHermesTextGeneration = Effect.fn("makeHermesTextGeneration")(function* (
  ...
  const runHermesJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      // Hermes ACP startup costs roughly three seconds, but ProviderInstance
      // requires text generation and no cheaper supported path exists.
        ...
        yield* applyHermesAcpModeSelection({
          ...
          mapError: (cause) =>
            new TextGenerationError({
              operation,
              detail: "Failed to set Hermes ACP mode for text generation.",
              cause,
            }),
        });
  ...
  const generateSpeechScript: TextGeneration.TextGeneration["Service"]["generateSpeechScript"] =
    Effect.fn("HermesTextGeneration.generateSpeechScript")(function* (input) {
  ...
  const generateMessageSummary: TextGeneration.TextGeneration["Service"]["generateMessageSummary"] =
    Effect.fn("HermesTextGeneration.generateMessageSummary")(function* (input) {
