...
export const makeAntigravityTextGeneration = Effect.fn("makeAntigravityTextGeneration")(function* (
  ...
  const generateSpeechScript: TextGeneration.TextGeneration["Service"]["generateSpeechScript"] =
    Effect.fn("AntigravityTextGeneration.generateSpeechScript")(function* (input) {
      const generated = yield* runAntigravityJson({
  ...
  const generateMessageSummary: TextGeneration.TextGeneration["Service"]["generateMessageSummary"] =
    Effect.fn("AntigravityTextGeneration.generateMessageSummary")(function* (input) {
      const generated = yield* runAntigravityJson({
        operation: "generateMessageSummary",
        ...buildMessageSummaryPrompt(input),
        modelSelection: input.modelSelection,
      });
