...
// Resolved, because macOS hands out temp dirs under /var, which is itself a
// symlink to /private/var. Leaving that in makes the symlink case below compare
// an unresolved module URL against a resolved realpath and always fail.
const makeTempDir = () =>
