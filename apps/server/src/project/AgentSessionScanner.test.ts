...
const makeTempDir = Effect.fn("AgentSessionScanner.test.makeTempDir")(function* (prefix: string) {
  ...
  // macOS temp dirs live under /var, a symlink to /private/var. The scanner
  // compares realpaths against the configured worktrees prefix, so hand it a
  // canonical base or the symlink exclusion never matches.
