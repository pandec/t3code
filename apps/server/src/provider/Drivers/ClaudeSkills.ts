 ...
 * is best-effort: unreadable roots are skipped and a skill whose frontmatter
 * fails to parse still contributes whatever fields are recoverable, so a broken
 * skill never degrades the provider snapshot. On name collisions,
