...
function ProjectDetail({
  ...
  const inheritedEnvModeText = inheritedEnvModeLabels({
    ...
    globalEnvMode: settings.defaultThreadEnvMode,
  });
        ...
        <SettingsRow
          ...
          control={
            ...
            >
              ...
              <SelectPopup align="end" alignItemWithTrigger={false}>
                <SelectItem value="inherit">{inheritedEnvModeText.inheritItem}</SelectItem>
        ...
        <SettingsRow
          ...
          control={
            <ProviderAccentColorPicker
              ...
              commitDelayMs={120}
              onCommit={(color) =>
                updateProjectAccentColor(color === "" ? null : (color as SidebarProjectAccentColor))
              }
            />
          }
        />
