        ...
        <div ref={setTimelineViewportElement} className="relative h-full min-h-0">
          <LegendList<MessagesTimelineRow>
            ...
            maintainVisibleContentPosition={{
              data: true,
              // Once follow is off the user is reading history, so rows
              // resizing above the viewport (streaming, disclosure toggles,
              // prepended pages) must not move what they are looking at.
