...
export const ExpandedImageDialog = memo(function ExpandedImageDialog({
  ...
  useEffect(() => {
    const onEscape = (event: globalThis.KeyboardEvent) => {
      ...
      // active pane's dialog owns Escape then. A lone dialog keeps it even
      // from the inactive pane: it covers the whole window, so gating it off
      // would strand a keyboard-undismissable modal (reachable via mod+\
      // while the dialog is open). Arrow keys are scoped by dialog focus.
      if (
