...
export type ComposerSlashCommand =
  ...
  | "t3-wait";
/**
 * "alternate" is the modifier-Enter delivery into a running turn: the composer
 * maps it onto the thread outbox's other intent (queue for later instead of steer).
 */
