 ...
 * thread's recording sits mid-way, or null (including once it has played to
 * the end). String snapshots bail out of re-renders exactly like the previous
 * boolean selector did.
 */
