...
import type { SettingsSliderRow as SharedSettingsSliderRow } from "./SettingsSliderRow";

/** Material slider for the settings rows; the min/max glyphs are an iOS affordance. */
export function SettingsSliderRow(props: ComponentProps<typeof SharedSettingsSliderRow>) {
  const {
    themeAppearance,
    systemColorsActive,
