 ...
 * lets the user push the reference out. Applying it copies only the keys this
 * section edits, leaving each environment's other defaults and overrides intact.
 */
