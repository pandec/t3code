...
export const make = Effect.gen(function* () {
  ...
  // Suffix the entry per identity so a Dev-packaged build cannot overwrite the
  // production handler entry (mirrors linuxDesktopEntryName).
  const desktopEntryName = environment.usesDevelopmentIdentity
