...
export const OrchestrationThread = Schema.Struct({
  ...
  movedToTopAt: Schema.optional(Schema.NullOr(IsoDateTime)),
...
export const OrchestrationThreadShell = Schema.Struct({
  ...
  // Optional so clients can fall back to hasPendingUserInput with older servers.
  hasPendingBlockingUserInput: Schema.optional(Schema.Boolean),
...
const ThreadMoveToTopCommand = Schema.Struct({
  type: Schema.Literal("thread.move-to-top"),
  commandId: CommandId,
  threadId: ThreadId,
  movedToTopAt: IsoDateTime,
});
...
export const ThreadTurnStartCommand = Schema.Struct({
  ...
  titlePinned: Schema.optional(Schema.Boolean),
  runtimeMode: RuntimeMode.pipe(Schema.withDecodingDefault(Effect.succeed(DEFAULT_RUNTIME_MODE))),
  interactionMode: ProviderInteractionMode.pipe(
    Schema.withDecodingDefault(Effect.succeed(DEFAULT_PROVIDER_INTERACTION_MODE)),
  ),
...
export const ThreadMovedToTopPayload = Schema.Struct({
  threadId: ThreadId,
  movedToTopAt: IsoDateTime,
});
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.moved-to-top"),
    payload: ThreadMovedToTopPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
