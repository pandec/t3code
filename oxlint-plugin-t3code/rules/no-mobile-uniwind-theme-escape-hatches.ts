...
const THEME_INTEROP_ALLOWLIST = new Set([
  ...
  // Fork: FontSizeSliderRow was generalized into SettingsSliderRow; the native
  // slider track/fill colors still cross the JS boundary as raw values.
  "features/settings/components/SettingsSliderRow.tsx",
  ...
  // Fork: the attention filter's active tint feeds React Navigation's native
  // header items, which cannot consume a className.
