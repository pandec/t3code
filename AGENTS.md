...
- UI changes need before/after images. Motion or timing needs a short video. Private-fork pull requests are
  exempt: do not capture images or video for them, and do not launch a client just to produce them.
