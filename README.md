...
- **Thread naming & sidebar polish** — split thread naming with refined fork titles; Sidebar V2 adds optional two-line active-thread cards, per-project color accents, one-click project-filter clearing, and a setting to show each thread's provider icon on hover or at all times.
