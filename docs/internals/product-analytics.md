...
OpenCode sums unique main-session step totals. Cursor, Grok, Hermes, and
Antigravity usage stays `unavailable` until their ACP token fields and scope are verified.
